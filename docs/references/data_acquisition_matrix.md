...
**Bottom line**: for open chronic **field-potential** speech data, **Angrick 2024 (row 16) is effectively the only option that exists**. All other chronic speech data is Utah (out of scope), gated (UCSF BRAVO, Littlejohn), paper-only (Evanson, WIMAGINE), or private (NYU).
...
4. NeuroListen (open sEEG listening + audio)
5. Podcast ECoG (ds005574)
6. sEEG Passive listening (ds004703)
7. Naturalistic film iEEG (ds003688)
8. BrainStratify (epidural ECoG slice)
9. VocalMind (imagined-speech mode)
10. **Angrick chronic ALS ECoG** ★ (only open chronic field-potential speech data; Phase 2+ stability ablations)
11. **Kanno 2025 Auditory Naming (ds005545)** (verify rebadge vs ds006234 *before* any use)
...
| **MVPFormer** (Carzaniga/IBM) | ICLR 2026 | **SWEC iEEG** (9,328 h verified) | 9,328 h | 68 | sEEG (long-term) | Y (row 22) |
| **BaRISTA** (Oganesian/Shanechi) | NeurIPS 2025 | **Brain Treebank** only | ~43.5 h | 10 | sEEG | Y (row 21) |
