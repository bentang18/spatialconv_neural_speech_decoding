...
|---|---|---|
| **Stage 1 (Phase 1)** | Single-sensor supervised correctness pass on uECoG | [`strategy/stage_1.md`](strategy/stage_1.md) |
| Stage 2 (Phase 1.5) | In-sensor scaling: supervised expansion + SSL | *TBD — created when Stage 1 concludes* |
| Stage 3 (Phase 2) | Cross-sensor join (uECoG + sEEG) | *TBD* |
