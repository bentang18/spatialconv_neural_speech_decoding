...
Source: 3D Euclidean pool over fsaverage pial vertices, sigma=1.3 mm, radius=5.0 mm, crown_bias=on, atlas=fsaverage_bake_v2b/smoothed, sliced to 15 `DEFAULT_BASE_PARCELS` columns (raw [0, 100] BNA probability).
...
|---|---|---|---|---|---|---|---|---|---|
| S14 | 128 | 128 | 0 | 0 | 0 | 10 | 79 | 39 | 0 |
| S16 | 128 | 128 | 0 | 0 | 0 | 10 | 103 | 15 | 0 |
| S23 | 128 | 128 | 0 | 0 | 0 | 18 | 83 | 13 | 14 |
| S26 | 128 | 128 | 0 | 0 | 0 | 0 | 67 | 27 | 34 |
| S33 | 256 | 256 | 0 | 0 | 0 | 1 | 170 | 69 | 16 |
| S39 | 256 | 256 | 0 | 0 | 0 | 17 | 138 | 101 | 0 |
| S62 | 256 | 256 | 0 | 0 | 0 | 0 | 116 | 119 | 21 |
