...
> **HISTORICAL**: This log covers CTC→CE tuning and LOPO pilot (2026-03). The current best is per-phoneme MFA + flat head (PER 0.734, 2026-04-04). See `archive/experiment_log.md` findings 86-101 for current results.
