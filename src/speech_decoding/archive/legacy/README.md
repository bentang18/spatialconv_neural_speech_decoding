...
See `docs/current_direction.md`, `docs/implementation_start.md`, `docs/implementation_tasks.md`, and memory file `project_v14_phase1_contract_2026_04_13.md` for the Phase-1 contract and the active blocker list.
