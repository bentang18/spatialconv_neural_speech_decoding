#!/bin/bash
# DCC SLURM array for v14 pooled Q1a: 4 core patients × 5 folds × 3 seeds.
#
# One model per (fold, seed, depth=3) trained on all 4 core patients with
# same-token-global CV and round-robin interleave. 15 jobs total.
#
...
#     task_id = fold * 3 + seed
#
#SBATCH --job-name=v14pp_pooled_q1a
...
OUT_DIR=/work/ht203/results/v14_pooled/Q1a_4core_d32_depth${DEPTH}
