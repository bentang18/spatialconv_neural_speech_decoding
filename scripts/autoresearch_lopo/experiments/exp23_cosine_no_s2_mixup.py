#!/usr/bin/env python3
"""exp23: Cosine classifier + no Stage 2 mixup.

Combines exp20 (cosine classifier) with no-mixup in Stage 2.
Cosine classifier forces features onto unit sphere (helps k-NN).
No S2 mixup avoids noisy interpolation on ~120 target trials.
"""
...
if __name__ == "__main__":
    ...
    print(f"EXP23: Cosine classifier + no S2 mixup, temp_init={COSINE_TEMPERATURE_INIT}")
    print()
