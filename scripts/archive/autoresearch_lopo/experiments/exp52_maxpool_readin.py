#!/usr/bin/env python3
"""Exp 52: MaxPool instead of AvgPool in read-in.

AvgPool blurs spatial features. MaxPool preserves peak activations —
may better preserve sharp spatial gradients from somatotopic organization.

Baseline: AdaptiveAvgPool2d(4,8), PER=0.762
Change: AdaptiveMaxPool2d(4,8)
"""
...
if __name__ == "__main__":
    run(ReadInCls=MaxPoolReadIn, BackboneCls=Backbone,
        ...
        experiment_name="exp52_maxpool_readin")
